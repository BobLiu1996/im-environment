...
INSERT INTO `im`.`im_user`(`id`, `user_name`, `nick_name`, `head_image`, `head_image_thumb`, `password`, `sex`, `type`, `signature`, `last_login_time`, `created_time`) VALUES (10000000001, 'mystic', 'mystic', 'http://127.0.0.1:9000/mystic-im/image/20240218/1708269405038.jpg', 'http://127.0.0.1:9000/mystic-im/image/20240218/1708269405144.jpg', '$2a$10$zNg07bH1WLTsInbI6iRmhexsk.CcXgHTV2c87UAVRnFDukAAZ9jMu', 0, 1, '', NULL, '2024-02-12 21:13:55');
